	...
	try {
		...
		for (const GetReplyPreviewUpdater of [
			defineToolUseBlocks([
				...
				{ start: '<inline-js>', end: '</inline-js>' },
				{ start: '<inline-bash>', end: '</inline-bash>' },
				{ start: '<inline-pwsh>', end: '</inline-pwsh>' },
				{ start: '<inline-powershell>', end: '</inline-powershell>' },
				{ start: '<inline-cmd>', end: '</inline-cmd>' },
