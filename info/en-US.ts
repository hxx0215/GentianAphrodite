...
import type { I18NInfoType } from "./index.ts"
const { chardir, charurl, charvar } = Charbase
 ...
 */
export async function update(): Promise<I18NInfoType> {
...
🗓️ Your first chat with Gentian was in ${statisticDatas.firstInteraction.chat_name} on ${timeToStr(statisticDatas.firstInteraction.time as any, 'en-US')}, which was ${timeToTimeStr(Date.now() - (statisticDatas.firstInteraction.time as any), 'en-US')} ago ⏳

💬 Your first message sent was

<pre><code>
${escapeHTML(statisticDatas.firstInteraction.userMessageContent as any)}
</code></pre>

💬 Her reply was:

<pre><code>
${escapeHTML(statisticDatas.firstInteraction.characterReplyContent as any)}
</code></pre>
