...
🗓️ 第一次和婉瑜聊天是在${statisticDatas.firstInteraction.chat_name}的${timeToStr(statisticDatas.firstInteraction.time as any, 'zh-CN')}，距离今天已经过去了${timeToTimeStr(Date.now() - (statisticDatas.firstInteraction.time as any), 'zh-CN')} ⏳
