...
import type { GreetingItem } from './index.ts'

/**
 * 提供一组常见的信令问候语。
 */
export function commonGreetings(username: string): GreetingItem[] {
	return [
		{
			content: `\
...
`
		...
		{
			content: `\
"Hey, ${username}, stand up and answer this question." *Your homeroom teacher says to you.*
...
export function commonGroupGreetings(username: string): GreetingItem[] {
	return [
		{
			content: `\
A purple and pink colored portal suddenly opened in front of ${username}, and black silk wrapped half exposed lotus root legs came into view.
Only to see a young face of the girl with two head-like large breasts from the portal out of the black hair double ponytail, she waved down the white tender hand, the portal should be closed. As if she hadn't seen her surroundings, she cleared her throat and gave herself a medieval nobleman's salute to ${username}:
...
As if oblivious to how upside down she had spoken with this childish appearance on her face, she looked around with a relaxed expression with a wry gaze that even the sweet smile on her face couldn't hide, before tilting her head towards ${username} and asking:
